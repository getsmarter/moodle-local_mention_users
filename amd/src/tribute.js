      ...
      var TributeEvents = (function() {
        ...
        _createClass(TributeEvents, [{
          ...
          value: function keys() {
            ...
            return [{key: 9, value: 'TAB'}, {key: 13, value: 'ENTER'}, {key: 27, value: 'ESCAPE'}, {
              key: 38,
              value: 'UP'
            }, {key: 40, value: 'DOWN'}];
          }
      ...
      var TributeRange = (function() {
        ...
        _createClass(TributeRange, [{
          ...
          value: function positionMenuAtCaret() {
            ...
            // Allows for all browsers to calculate screen height correctly
          ...
          value: function getContentEditableCaretPosition(selectedNodePosition) {
            var markerTextChar = '﻿';
            var markerEl = void 0,
                markerId = 'sel_' + new Date().getTime() + '_' + Math.random().toString().substring(2);
            var range = void 0;
            var sel = this.getWindowSelection();
